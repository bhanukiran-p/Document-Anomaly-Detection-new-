"""
Bank of America Bank Statement Normalizer
Maps Bank of America-specific fields to standardized bank statement schema
"""
...
class BankOfAmericaNormalizer(BankStatementBaseNormalizer):
    """
    Normalizer for Bank of America bank statements
    ...
    def normalize(self, ocr_data: Dict):
        """
        Normalize Bank of America bank statement data
