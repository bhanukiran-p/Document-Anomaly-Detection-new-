...
# Import enhanced signature detector (if available)
try:
...
class MoneyOrderFeatureExtractor:
    """
    ...
    def __init__(self):
        ...
        self.advanced_extractor = MoneyOrderAdvancedFeatureExtractor()
    ...
    def _check_amount_consistency(self, amount: str, amount_words: str) -> float:
        ...
        # Simple heuristic: if both exist, assume consistency
        # More sophisticated matching would parse the words
