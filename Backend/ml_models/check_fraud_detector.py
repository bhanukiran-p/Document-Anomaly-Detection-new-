...
class CheckFraudDetector:
    ...
    def __init__(self, model_dir: str = 'ml_models'):
        ...
        # Model paths
        self.rf_model_path = os.path.join(model_dir, 'check_random_forest.pkl')
        self.xgb_model_path = os.path.join(model_dir, 'check_xgboost.pkl')
        self.scaler_path = os.path.join(model_dir, 'check_feature_scaler.pkl')
