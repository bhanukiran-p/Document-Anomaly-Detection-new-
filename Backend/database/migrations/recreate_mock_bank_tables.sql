...
DROP TABLE IF EXISTS mock_bank_connections CASCADE;
DROP TABLE IF EXISTS synthetic_transactions CASCADE;
DROP TABLE IF EXISTS synthetic_accounts CASCADE;
DROP TABLE IF EXISTS synthetic_customers CASCADE;
...
CREATE TABLE mock_bank_connections (
...
CREATE INDEX idx_synthetic_accounts_customer ON synthetic_accounts(customer_id);
CREATE INDEX idx_synthetic_transactions_account ON synthetic_transactions(account_id);
CREATE INDEX idx_synthetic_transactions_customer ON synthetic_transactions(customer_id);
CREATE INDEX idx_synthetic_transactions_timestamp ON synthetic_transactions(timestamp);
CREATE INDEX idx_mock_bank_connections_user ON mock_bank_connections(user_id);
